...
//  True.
//
//  Created by Julien Segers on 25/07/2020.
...
class ProfileController: UIViewController {
    ...
    private let bioLabel: UILabel = {
        ...
        label.numberOfLines = 0
        label.font = UIFont.systemFont(ofSize: 20)
        label.text = "fdjksfpijsiogejgseio"
        return label
    }()
    ...
    func configureBarStackView() {
        ...
        barStackView.anchor(top: view.topAnchor, left: view.leftAnchor, right: view.rightAnchor, paddingTop: 35, paddingLeft: 8, paddingRight: 8, height: 4)
    }
