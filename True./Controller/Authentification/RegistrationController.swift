...
class RegistrationController: UIViewController {
    ...
    private let nameTextField = CustomTextField(placeholder: "Full Name", isSecure: false)
    ...
    func configureUI() {
        ...
        let stack = UIStackView(arrangedSubviews: [nameTextField, emailTextField, passwordTextField, registerButton])
        stack.axis = .vertical
        stack.spacing = 16
        ...
        goToLoginButton.anchor(left: view.leftAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor, right: view.rightAnchor, paddingLeft: 32, paddingBottom: 20, paddingRight: 32)
    }
